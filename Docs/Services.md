...
If Android rejects foreground-service startup, the lifetime controller reports a typed user-visible operational failure, submits an authoritative stop, and keeps observing future sessions. Audio never continues into the background without the required service protection.
