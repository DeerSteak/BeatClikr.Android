...
The current transport records practice from ViewModel behavior. The target playback state machine must confirm meaningful audible playback before history is written, preventing focus-denied or immediately interrupted sessions from counting.
