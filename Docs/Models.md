...
- `TempoRampConfiguration` owns the supported ramp increments and intervals. Shipping ramp state lives in `RampController` and submits phase-preserving standard updates.
