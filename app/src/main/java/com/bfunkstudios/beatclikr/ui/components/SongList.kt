...
@Composable
fun SongList(uiState: SongLibraryUiState, viewModel: SongLibraryViewModel, navigateToDetail:() -> Unit = {}) {
...
@Composable
fun SongListItem(song: Song, songListViewModel: SongLibraryViewModel, navigateToDetail: () -> Unit) {
